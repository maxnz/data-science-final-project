...
Each season seems to have a general improvement in scores as the weeks progress, but it is not a significant amount and 
...
For example, the 2010 competition had an average match score of 4.07, while the 2018 competition had an average match score of 219.90.
...
These results aren't too shocking, but they give us some useful information to keep in mind later. Cleary, the average score percentile for a team that attends a lot of events will be higher than a team that attends few since higher scoring teams are able to compete in more events.
